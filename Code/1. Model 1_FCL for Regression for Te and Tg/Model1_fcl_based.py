...
with tf.Session() as sess:
   sess.run(init)
   # saver.restore(sess, "Weighting_factor.ckpt")
   batch=512
   ...
   for step in range(300):
      ...
      if (step+1) % 10 == 0:
         save_path = saver.save(sess, "Weighting_factor.ckpt")
   ...
   sio.savemat('fcl_wb_simp.mat', {'fcl_wb' :fcl_wb})

   sio.savemat('xmean_simp.mat',{'xmean' :Xmean})
   sio.savemat('xsig_simp.mat',{'xsig' :Xsig})
   sio.savemat('ymean_simp.mat',{'ymean' :Ymean})
   sio.savemat('ysig_simp.mat',{'ysig' :Ysig})